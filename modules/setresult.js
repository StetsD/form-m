            ...
            if(config.$blockForm){
                ...
                this.ERRORS_MSG = (config.ERRORS_MSG) ? config.ERRORS_MSG : {
                    ...
                    keyError:{
                        ...
                        oE: ((config.ERRORS_MSG) ? config.ERRORS_MSG.keyError.oE : '') ? config.ERRORS_MSG.keyError.oE: 'Разрешены только цифры, спецсимволы и символы алфавита',
                        oP: ((config.ERRORS_MSG) ? config.ERRORS_MSG.keyError.oP : '') ? config.ERRORS_MSG.keyError.oP: 'Разрешены только цифры, спецсимволы и символы латинского алфавита'
                    },
                    required:{
            ...
            if(state.length){
                state.forEach(function(item){
                    ...
                    if(item.validation === 'error'){
                        ...
                        if(parentItem){
                            $parrentItem.addClass(that.clsSuccessInput);
                            $elemErrorMsg.text('');
                        }else{
